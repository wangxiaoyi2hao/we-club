...
@interface InviteTableViewCell : UITableViewCell<UICollectionViewDelegateFlowLayout,UICollectionViewDataSource>
...
#pragma mark 
@property(nonatomic,weak)IBOutlet UIButton*buttonAround;
@end
