...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      {
        .name = "clubDistance",
        .number = BriefClub_FieldNumber_ClubDistance,
        .hasIndex = 4,
        .flags = GPBFieldOptional | GPBFieldTextFormatNameCustom,
        .dataType = GPBDataTypeString,
        .offset = offsetof(BriefClub__storage_, clubDistance),
        .defaultValue.valueString = nil,
        .dataTypeSpecific.className = NULL,
        .fieldOptions = NULL,
      },
    ...
    const char *extraTextFormatInfo = NULL;
#else
    static const char *extraTextFormatInfo = "\t\003\n\000\004\014\000\005\014\000\006\013\000\007\t\000\010\013\000\t\014\000\n\r\000\013\000livePhotos\000";
#endif  // GPBOBJC_SKIP_MESSAGE_TEXTFORMAT_EXTRAS
    GPBDescriptor *localDescriptor =
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      {
        .name = "order",
        .number = UserAvatar_FieldNumber_Order,
        .hasIndex = 2,
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeInt32,
        .offset = offsetof(UserAvatar__storage_, order),
        .defaultValue.valueInt32 = 0,
        .dataTypeSpecific.className = NULL,
        .fieldOptions = NULL,
      },
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    const char *extraTextFormatInfo = NULL;
#else
    static const char *extraTextFormatInfo = "\r\003\000userAvatar\000\007\014\000\010\010\000\n\014\000\016\013\000\021\014\000\022\016\000\024\013\000\025\013!!\000\026\000bindApps\000\027\013\000\030\r\000\032\t\000";
#endif  // GPBOBJC_SKIP_MESSAGE_TEXTFORMAT_EXTRAS
    GPBDescriptor *localDescriptor =
