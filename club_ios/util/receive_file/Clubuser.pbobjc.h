...
typedef GPB_ENUM(Request10001_Params_FieldNumber) {
  ...
  Request10001_Params_FieldNumber_Md5Psw = 2,
  Request10001_Params_FieldNumber_OtherId = 3,
  Request10001_Params_FieldNumber_DiviceNumber = 4,
  Request10001_Params_FieldNumber_RegisterType = 5,
};
...
// 注册方式 1：手机号注册 2：QQ授权登录注册 3：微博授权登录注册 4：微信授权登录注册
...
typedef GPB_ENUM(Response10001_Data_FieldNumber) {
  Response10001_Data_FieldNumber_UseId = 1,
  Response10001_Data_FieldNumber_UserKey = 2,
  Response10001_Data_FieldNumber_VClubId = 3,
};

@interface Response10001_Data : GPBMessage

// 用户id
@property(nonatomic, readwrite, copy, null_resettable) NSString *useId;

// 用户key
@property(nonatomic, readwrite, copy, null_resettable) NSString *userKey;

//VClub ID
@property(nonatomic, readwrite, copy, null_resettable) NSString *vClubId;
...
typedef GPB_ENUM(Request10002_Params_FieldNumber) {
  Request10002_Params_FieldNumber_Type = 1,
  Request10002_Params_FieldNumber_Account = 2,
  Request10002_Params_FieldNumber_Md5Psw = 3,
  Request10002_Params_FieldNumber_OtherId = 4,
};
...
// code message:(901 第三方账号未注册--前端重新调第三方注册的接口，后跳转到补全信息页面--易林的逻辑)
@property(nonatomic, readwrite) BOOL hasCommon;
@property(nonatomic, readwrite, strong, null_resettable) ResponseCommon *common;
...
typedef GPB_ENUM(Response10002_Data_FieldNumber) {
  ...
  Response10002_Data_FieldNumber_RongyunToken = 6,
  Response10002_Data_FieldNumber_UpdateState = 7,
  Response10002_Data_FieldNumber_LastedVersion = 8,
  Response10002_Data_FieldNumber_DownloadURL = 9,
  Response10002_Data_FieldNumber_Avatarurl = 10,
  Response10002_Data_FieldNumber_Type = 12,
};
...
typedef GPB_ENUM(Request10003_Params_FieldNumber) {
  Request10003_Params_FieldNumber_Userid = 1,
};

@interface Request10003_Params : GPBMessage

//可选 如果设置，则获取这个用户的简要信息    如果不设置 则获取请求用户的简要信息
@property(nonatomic, readwrite, copy, null_resettable) NSString *userid;
...
typedef GPB_ENUM(Response10003_Data_FieldNumber) {
  ...
  Response10003_Data_FieldNumber_FollowerNumber = 4,
  Response10003_Data_FieldNumber_FriendNumber = 5,
  Response10003_Data_FieldNumber_FollowNumber = 6,
  Response10003_Data_FieldNumber_DataIntegrity = 7,
};
...
//粉丝量
@property(nonatomic, readwrite) int32_t followerNumber;

//好友量
@property(nonatomic, readwrite) int32_t friendNumber;

//关注量
@property(nonatomic, readwrite) int32_t followNumber;
...
typedef GPB_ENUM(Request10007_Params_FieldNumber) {
  ...
  Request10007_Params_FieldNumber_SearchKey = 2,
};

@interface Request10007_Params : GPBMessage

//根据clubNumber搜索好友  ！ 该字段废弃
@property(nonatomic, readwrite) int64_t clubNumber;

// 搜索的关键字 可以是vclubnumber，也可以是模糊搜索的用户名
...
typedef GPB_ENUM(Request10022_FieldNumber) {
  Request10022_FieldNumber_Common = 1,
  Request10022_FieldNumber_Params = 2,
};

// 补全用户信息： 10022 填写基本资料 
//url: /userAction/completeBasicInfo
@interface Request10022 : GPBMessage
...
@property(nonatomic, readwrite) BOOL hasParams;
@property(nonatomic, readwrite, strong, null_resettable) Request10022_Params *params;

@end

#pragma mark - Request10022_Params

typedef GPB_ENUM(Request10022_Params_FieldNumber) {
  Request10022_Params_FieldNumber_UserName = 1,
  Request10022_Params_FieldNumber_Sex = 2,
  Request10022_Params_FieldNumber_Birthday = 3,
  Request10022_Params_FieldNumber_City = 4,
  Request10022_Params_FieldNumber_AvatarKey = 5,
};

@interface Request10022_Params : GPBMessage
...
//空间名__avatarKey 实例：“weclub__1.jpg”
...
typedef GPB_ENUM(Response10022_FieldNumber) {
  Response10022_FieldNumber_Common = 1,
  Response10022_FieldNumber_Data_p = 2,
};

@interface Response10022 : GPBMessage

@property(nonatomic, readwrite) BOOL hasCommon;
@property(nonatomic, readwrite, strong, null_resettable) ResponseCommon *common;

@property(nonatomic, readwrite) BOOL hasData_p;
@property(nonatomic, readwrite, strong, null_resettable) Response10022_Data *data_p;

@end

#pragma mark - Response10022_Data

typedef GPB_ENUM(Response10022_Data_FieldNumber) {
  Response10022_Data_FieldNumber_UserAvatar = 1,
  Response10022_Data_FieldNumber_UserName = 2,
  Response10022_Data_FieldNumber_Sex = 3,
  Response10022_Data_FieldNumber_Birthday = 4,
  Response10022_Data_FieldNumber_City = 5,
};

@interface Response10022_Data : GPBMessage
