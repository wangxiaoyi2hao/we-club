...
//        self.collectionView.contentInset = UIEdgeInsetsMake(0, (_viewHeight - _itemHeight) / 2, 0, (_viewHeight - _itemHeight) / 2);
        if (KScreenWidth==375) {
            self.collectionView.contentInset = UIEdgeInsetsMake(0, -25, 0, -25);
        }else if(KScreenWidth == 320){
            self.collectionView.contentInset = UIEdgeInsetsMake(0, -55, 0, -55);
    ...
    switch (self.carouselAnim) {
        ...
        case HJCarouselAnimCarousel:
            if (KScreenWidth==375) {
                ...
                centerY = cY + sin(ratio * M_PI_2) * _itemHeight * 1.5;
            }
            break;
