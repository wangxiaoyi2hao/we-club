        ...
        if(animated){
            ...
            [UIView animateWithDuration:kTransformPart1AnimationDuration animations:^{
                ...
                [UIView animateWithDuration:.2 animations:^{
                    ...
                    [UIView animateWithDuration:kFadeInAnimationDuration delay:1 options:UIViewAnimationOptionCurveEaseOut animations:^{
                        containerView.alpha = 1;
                        containerView.transform = CGAffineTransformScale(CGAffineTransformIdentity, 1, 1);
...
//    [self hideAnimated:YES quView:nil withCompletionBlock:nil];
}
...
- (void)hideAnimated:(BOOL)animated withCompletionBlock:(void(^)())completion {
    ...
    for (UIView *view in effectBlurView.window.subviews) {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [UIView animateWithDuration:kTransformPart1AnimationDuration animations:^{
            self.containerView.transform = CGAffineTransformScale(CGAffineTransformIdentity, 0.1,0.1);
        } completion:^(BOOL finished){
...
//        [[HWPopTool sharedInstance]hideAnimated:YES quView:nil withCompletionBlock:nil];
